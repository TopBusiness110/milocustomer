...
import 'package:milocustomer/core/api/end_points.dart';
import 'package:milocustomer/core/error/exceptions.dart';
import 'package:milocustomer/core/error/failures.dart';
...
//
  Future<Either<Failure, ConfigModel>> getConfig() async {
    ...
    try {
      ...
      return Right(ConfigModel.fromJson(response));
    } on ServerException {
      return Left(ServerFailure());
    }
  }
  Future<Either<Failure, ConfigModel>> getAddressFromGeocode() async {
    //LoginModel loginModel = await Preferences.instance.getUserModel();
    try {
      final response = await dio.get(
        EndPoints.configUri,
