...
import 'package:milocustomer/core/widgets/cart_widget.dart';
import 'package:milocustomer/features/chat/conversation_screen.dart';
import 'package:milocustomer/features/dashboard/widget/bottom_nav_item.dart';
import 'package:milocustomer/features/home/home_screen.dart';
import 'package:milocustomer/features/order/order_screen.dart';
        ...
        BottomAppBar(
          ...
          child: Padding(
            ...
            child: Row(children: [
              ...
              BottomNavItem(iconData: Icons.person_2_outlined, isSelected: _pageIndex == 1, onTap: () => _setPage(1)),
              const Expanded(child: SizedBox()),
              BottomNavItem(iconData: Icons.message, isSelected: _pageIndex == 2, onTap: () => _setPage(2)),
              BottomNavItem(iconData:Icons.file_copy, isSelected: _pageIndex == 3, onTap: () => _setPage(3)),
