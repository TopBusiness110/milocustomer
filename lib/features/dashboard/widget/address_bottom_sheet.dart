          ...
          return Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Flexible(
              child: SingleChildScrollView(
                padding: const EdgeInsets.symmetric(horizontal: getSize(context)/22, vertical: getSize(context)/22),
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [

                  Text('${'hey_welcome_back'.tr}\n${'which_location_do_you_want_to_select'.tr}', style: TextStyle(fontSize: Dimensions.fontSizeDefault)),
                  ...
                  locationController.addressList != null && locationController.addressList!.isEmpty
                      ? const SizedBox(height: getSize(context)/22) : const SizedBox(),

                  Align(
                    alignment: locationController.addressList != null && locationController.addressList!.isNotEmpty ? Alignment.centerLeft : Alignment.center,
                  ...
                  SizedBox(height: locationController.addressList != null && locationController.addressList!.isEmpty ? 0 : getSize(context)/22),
                  ...
                  locationController.addressList != null && locationController.addressList!.isNotEmpty ? TextButton.icon(
                    ...
                    label: Text('add_new_address'.tr, style: robotoMedium.copyWith(color: AppColors.primary)),
                  ) : const SizedBox(),
