...
class RunningOrderViewWidget extends StatelessWidget {
  ...
  const RunningOrderViewWidget({Key? key, required this.reversOrder, required this.onMoreClick}) : super(key: key);
          ...
          ListView.builder(
              ...
              itemBuilder: (context, index){
                ...
                return InkWell(
                  ...
                  child: Container(
                    margin: const EdgeInsets.only(bottom: Dimensions.paddingSizeExtraSmall, top: getSize(context)/22),
                    ...
                    child:  Padding(
                      ...
                      child: Row( crossAxisAlignment: CrossAxisAlignment.center, children: [
                        ...
                        SizedBox(width: isFirstOrder ? 0 : getSize(context)/22),
                          ...
                          child: Column(mainAxisAlignment: isFirstOrder ? MainAxisAlignment.center : MainAxisAlignment.start,
                              crossAxisAlignment: isFirstOrder ? CrossAxisAlignment.center : CrossAxisAlignment.start, children: [
                                Row( mainAxisAlignment: isFirstOrder ? MainAxisAlignment.center : MainAxisAlignment.start, children: [
                                  ...
                                  Text('${'your_order_is'.tr} ', style: TextStyle(fontSize: Dimensions.fontSizeDefault)),
                                  Text(reversOrder[index].orderStatus!.tr, style: TextStyle(fontSize: Dimensions.fontSizeDefault, color: AppColors.primary)),
                                ]) ,
                        ...
                        Container(
                          ...
                          child: isFirstOrder ? !(reversOrder.length < 2) ? InkWell(
                            ...
                            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                              Text('+${reversOrder.length - 1}', style: TextStyle(fontSize: getSize(context)/24, color: AppColors.primary)),
                              Text('more'.tr, style: TextStyle(fontSize: Dimensions.fontSizeExtraSmall, color: AppColors.primary)),
                            ]),
  ...
  Widget trackView(BuildContext context, {required bool status}) {
    return Container(height: 5, decoration: BoxDecoration(color: status ? AppColors.primary
        : AppColors.disabledColor.withOpacity(0.5), borderRadius: BorderRadius.circular(Dimensions.radiusDefault)));
  }
}
